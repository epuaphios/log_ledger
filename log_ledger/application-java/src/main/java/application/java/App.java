...
public class App {
	...
	public static Gateway connect() throws Exception{
		...
		// load a CCP
		Path networkConfigPath = Paths.get("../../fabric-samples/test-network/organizations/peerOrganizations/org1.example.com");
	...
	public static void main(String[] args) throws Exception {
		...
		try (Gateway gateway = connect()) {
			...
			Contract contract = network.getContract("basicj");
